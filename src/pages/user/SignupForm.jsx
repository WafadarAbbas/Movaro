            ...
            {activeStep === 0 && (
              <Box>
                ...
                <Typography variant="subtitle2" color="grey" mt={2} mb={3}>
                  Your information will be retrieved in cooperation with BankID
                  and Bisenode.{" "}
                  ...
                  <FormControlLabel
                    ...
                    label={
                      <Typography variant="subtitle3">
                        By logging in, you confirm that your information is
                        ...
                        and used only to verify your identity and secure
                        transactions.
                      </Typography>
                    }
                  />
